...
-- lun. 01 juin 2020 19:51:45 CEST
...
-- -----------------------------------------------------
-- Table `portfolio_db`.`project_tehnos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `portfolio_db`.`project_tehnos` ;

CREATE TABLE IF NOT EXISTS `portfolio_db`.`project_tehnos` (
  `id` INT NULL,
  `toolbox_item_id` INT NOT NULL,
  `projects_id` INT(150) NOT NULL,
  INDEX `fk_project_tehnos_toolbox_item1_idx` (`toolbox_item_id` ASC),
  INDEX `fk_project_tehnos_projects1_idx` (`projects_id` ASC));
